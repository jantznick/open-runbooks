...
| **B2** | Threat modeling (internet-facing / medium+ tier) | 01 | [01-plan-and-design](program/01-plan-and-design.md) | [threat-model-template](templates/threat-model-template.md) · `AS-DES-002` |
